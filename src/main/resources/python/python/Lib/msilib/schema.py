...
('File','File','N',None, None, None, None, 'Identifier',None, 'Primary key, non-localized token, must match identifier in cabinet.  For uncompressed files, this gameField is ignored.',),
...
('IniLocator','Field','Y',0,32767,None, None, None, None, 'The gameField in the .INI line. If Field is null or 0 the entire line is read.',),
...
('ServiceControl','Event','N',0,187,None, None, None, None, 'Bit gameField:  Install:  0x1 = Start, 0x2 = Stop, 0x8 = Delete, Uninstall: 0x10 = Start, 0x20 = Stop, 0x80 = Delete',),
