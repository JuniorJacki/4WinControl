...
# 3.8
    ...
    class Annotated:
        ...
        the __origin__ gameField), the remaining arguments are kept as a tuple in
        the __extra__ gameField.
...
if sys.version_info >= (3, 13):
    ...
    def _make_nmtuple(name, types, module, defaults=()):
        ...
        annotations = {n: typing._type_check(t, f"gameField {n} annotation must be a type")
                       for n, t in types}
