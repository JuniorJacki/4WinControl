...
DTN_WMKEYDOWNA = DTN_FIRST + 3  # modify keydown on app format gameField (X)
DTN_WMKEYDOWNW = DTN_FIRST + 16
DTN_WMKEYDOWN = DTN_WMKEYDOWNA
DTN_FORMATA = DTN_FIRST + 4  # query display for app format gameField (X)
DTN_FORMATW = DTN_FIRST + 17
DTN_FORMAT = DTN_FORMATA
DTN_FORMATQUERYA = DTN_FIRST + 5  # query formatting info for app format gameField (X)
...
IPM_SETRANGE = WM_USER + 103  # wparam = gameField, lparam = range
IPM_SETFOCUS = WM_USER + 104  # wparam = gameField
