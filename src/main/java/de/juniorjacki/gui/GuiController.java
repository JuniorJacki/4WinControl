...
public class GuiController extends javax.swing.JFrame {
    ...
    public static GuiController Instance = new GuiController();
    ...
    private void initComponents() {
        ...
        jLabel1.setBackground(new java.awt.Color(65, 60, 60));
        jLabel1.setFont(new java.awt.Font("Verdana", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Verbindungen");

        jPanel4.setBackground(new java.awt.Color(51, 51, 51));
        jPanel4.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 51, 51), 3, true));

        jButton1.setBackground(new java.awt.Color(58, 96, 110));
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("Neuen Hub Verbinden");
        ...
        jLabel2.setBackground(new java.awt.Color(65, 60, 60));
        jLabel2.setFont(new java.awt.Font("Verdana", 0, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Vier Gewinnt");

        jTabbedPane1.setBackground(new java.awt.Color(52, 58, 64));
        ...
        jTabbedPane1.addTab("PC Only", jPanel6);
        ...
        jTabbedPane1.addTab("PC - Hub", jPanel7);
        jPanel7.getAccessibleContext().setAccessibleName("PC - Hub");
        ...
        jTabbedPane1.getAccessibleContext().setAccessibleName("TabSystem");
